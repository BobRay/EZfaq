...
$builder->create('EZFaq','1.0.5','beta');
$builder->registerNamespace('ezfaq',false,true);
...
$c->set('name', 'EZFaq');
$c->set('description', '<strong>1.0.5-beta</strong> Generates a FAQ page for your site.');
$c->set('category', 0);
$c->set('snippet', file_get_contents($sources['assets'] . 'ezfaq/snippet.ezfaq.php'));
